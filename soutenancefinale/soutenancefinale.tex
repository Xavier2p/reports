...
\clearpage
   ...
   \end{description}  
    ...
    \subsection{Remerciements}
        ...
        correction de nombreux \textsl{bugs}. Nous remercions pareillement \@Mace24 qui nous a conseillé tout au long du projet sur la gestion de notre temps et le déroulement des soutenances, ainsi qu'un rapport de \textsl{bugs} très complet. Nous remercions également les personnes qui ont soutenus et cru en notre projet.\\
