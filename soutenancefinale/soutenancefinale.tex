...
\clearpage
   ...
   \end{description}  
            ...
            \subsubsection{Multijoueur}
                ...
                \begin{figure}[h]
                    \centering
                    \includegraphics[scale=0.2]{multi_lobby.png}
            ...
            \begin{figure}[h]
                \centering
                \includegraphics[scale=0.3]{City_IA.JPG}
    ...
    \subsection{Remerciements}
        ...
        correction de nombreux \textsl{bugs}. Nous remercions pareillement \@Mace24 qui nous a conseillé tout au long du projet sur la gestion de notre temps et le déroulement des soutenances, ainsi qu'un rapport de \textsl{bugs} très complet.
    ...
    \begin{table}
        \caption{Chronologie du Projet, partie 1}
        \centering
        \begin{minipage}[t]{.7\linewidth}
            \color{gray}
            \rule{\linewidth}{1pt}
            \ytl{9 janvier}{Bourse aux projets}
            \ytl{13 janvier}{Support GitHub fonctionnel}
            \ytl{20 janvier}{Création du Multijoueur}
            \ytl{30 janvier}{Premier circuit créé}
            \ytl{16 février}{Première version de physique du jeu}
            \ytl{19 février}{Création du Site Web}
            \ytl{27 février}{Musiques implémentées}
    ...
    \begin{table}
        \caption{Chronologie du Projet, partie 2}
        \centering
        \begin{minipage}[t]{.7\linewidth}
            \color{gray}
            \rule{\linewidth}{1pt}
            ...
            \ytl{4 mai}{\AI\, version 3.0}
            \ytl{29 mai}{Système d'expréience et de niveau implémenté}
            \ytl{30 mai}{Voiture débloqué en fonction du niveau}
            \ytl{1 juin}{Sound Design des voitures}
            \ytl{1 juin}{Physique unique pour chaque voiture}
            \ytl{2 juin}{Options graphique et sonore du jeu implémentés}
            \ytl{3 juin}{Correction de \textsl{bugs} sur les modes \textsl{Timer} et \textsl{Solo}}
            \ytl{5 juin}{Mode Multijoueur fonctionnel}
            \ytl{6 juin}{Correction de bug}
            \rule{\linewidth}{1pt}
        \end{minipage}
    \end{table}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=22cm, angle=90]{principal3.png}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=15cm]{garage_soutenance.png}
        \caption{Garage}
    \end{figure}

    \begin{figure}[h]
        \centering
        \includegraphics[width=15cm]{bootstrap.png}
